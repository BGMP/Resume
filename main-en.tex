...
\resumeItemListStart
\item{Promoted from Senior Software Developer to CTO, leading the company's technology strategy and engineering operations.}
\item{Designed and managed the complete cloud infrastructure, including AWS services, CI/CD pipelines, deployment workflows, and GitHub administration.}
\item{Established engineering best practices, improved development processes, and led technical decision-making across the organization.}
\resumeItemListEnd

\resumeSubheading
{Aukko}{Santiago, Chile (Remote)}
{Senior Software Developer}{May 2024 -- Jun. 2025}
\resumeItemListStart
\item{Designed and developed full-stack web applications using Ruby on Rails, React, PostgreSQL, and REST APIs.}
\item{Built custom Python automation tools and web scrapers, including integrations with Chile's Mercado Público procurement platform.}
\item{Worked directly with clients to gather requirements, design technical solutions, and deliver production-ready software.}
\item{Served as the company's software engineer, laying the foundation for core systems and development workflows.}
\resumeItemListEnd

\resumeSubheading
{University of Bío-Bío}{Concepción, Chile}
{Part-time Lecturer in Software Engineering}{Apr. 2024 -- Sept. 2024}

\resumeSubheading
{Chilean Informatics Olympiad (OCI)}{Concepción, Chile}
{Competitive Programming Instructor (C/C++)}{Apr. 2022 -- Jul. 2023}
...
\resumeSubHeadingListEnd
  ...
  \resumeSubheading
  {University of Bío-Bío}{Concepción, Chile}
  {Master's in Computer Science}{Mar. 2024 -- Apr. 2026}
	\resumeSubheading
	{University of Bío-Bío}{Concepción, Chile}
	{Software Engineering}{Mar. 2020 -- Jan. 2024}
	\resumeSubHeadingListEnd
  ...
  \resumeSubHeadingListEnd
	...
	\item{
		\textbf{Cloud}{: AWS, Azure, DigitalOcean, SharePoint, CloudFlare}
	}
	\item{
		\textbf{Technologies and Tools}{: PostgreSQL, MySQL, MongoDB, Capistrano, Rake, Redis, Maven, Gradle, Guice, PyInstaller, Docker, Git, GitHub Actions, Sentry, Prisma ORM, Nginx, vsftpd, Airflow}
	}
	\resumeSubHeadingListEnd
